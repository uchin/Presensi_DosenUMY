...
public class WebViewUmy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_view_umy);
        ...
        getSupportActionBar().setTitle("Web Portal UMY");
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        progressBarWebs = (ProgressBar) findViewById(R.id.progressBarWebumy);
        webview = (WebView) findViewById(R.id.webViewUmy);
        ...
        if (savedInstanceState != null) {
            ...
            webview.loadUrl("http://www.umy.ac.id/");
            ...
            if (Intent.ACTION_VIEW.equals(getIntent().getAction())) {
                ...
                webview.loadUrl("http://umy.ac.id/");
            }*/
        }
    }

...
public class WebViewPanduan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_view_panduan);
        ...
        progressBarWebs = (ProgressBar) findViewById(R.id.progressBarWebpanduan);
        webview = (WebView) findViewById(R.id.webViewPanduan);
